...
def align(translucent_trace: Trace,
          translucent_reachability_graph: TranslucentReachabilityGraph,
          ignore_translucent: bool = False,
    ...
    return TranslucentAlignmentStateGraph(translucent_reachability_graph,
                                          translucent_trace,
                                          activity_weights).get_optimal_alignment(ignore_translucent=ignore_translucent)


def align_to_petri_net(translucent_trace: Trace,
    ...
    if not all('enabled' in event for event in translucent_trace):
        raise ValueError("The trace is not enriched with translucent information")
    return align(translucent_trace,
                 TranslucentReachabilityGraph(accepting_petri_net),
                 ignore_translucent=ignore_translucent)
